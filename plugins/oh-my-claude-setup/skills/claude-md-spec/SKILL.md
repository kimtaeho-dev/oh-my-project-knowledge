...
4. **도메인 맵 참조** — `.claude/DOMAIN_MAP.md` 한 줄 링크 (테이블은 CLAUDE.md에 직접 포함하지 않는다)
...
프로젝트 도메인 맵: `.claude/DOMAIN_MAP.md` 참조
...
- 도메인 → 파일 위치 매핑은 CLAUDE.md에 포함하지 않는다. `.claude/DOMAIN_MAP.md`에 작성하고 CLAUDE.md에는 참조 한 줄만 둔다 (init.md 1.5단계 참조)
